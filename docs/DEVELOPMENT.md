...
Version 0.2.3 targets the confirmed test-machine installation, Zotero 9.0.6
...
`.scaffold/build/zotero-classification-assistant-0.2.3.xpi`. The build invokes
...
3. Open **Tools → Plugins**, choose **Install Add-on From File**, and select
   `.scaffold/build/zotero-classification-assistant-0.2.3.xpi`.
